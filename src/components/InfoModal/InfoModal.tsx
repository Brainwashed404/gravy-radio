...
export function InfoModal({ onClose, favourites, onLoadFavs }: InfoModalProps) {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: (
        <ul className={styles.list}>
          <li><strong>Access</strong>: Tap the station name on the main screen to cycle into the visualiser. Keep tapping to move through all four screen modes: Station Name, Visualiser, Scroll Ticker, Visualiser.</li>
